...
const CourseManagement = ({ onSelectCourse }) => {
  ...
  const hasManagePermission = (course) => {
    ...
    if (currentUser.role === 'TEACHER' && (course.teacherId === currentUser.id || course.teacher === currentUser.name)) return true
    return false
  }
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {currentUser?.role === 'STUDENT' ? "Haven't joined any courses yet" : "No courses yet"}
            </h3>
